    ...
    return (
        <>
            <a
                ...
                href="https://www.linkedin.com/in/khadija-muhammad-tasiu-407240288"
                aria-label="LinkedIn"
                target="_blank"
            ...
            <a
                className="text-[var(--text-secondary)] hover:text-[var(--primary-color)] transition-colors"
                href="https://github.com/Dignifiedmt"
                aria-label="GitHub"
                target="_blank"
                rel="noopener noreferrer"
            >
            ...
            <a
                className="text-[var(--text-secondary)] hover:text-[var(--primary-color)] transition-colors"
                href="https://x.com/Dignifiedmt?s=09"
                aria-label="X"
                target="_blank"
                rel="noopener noreferrer"
            >
            ...
            <a
                className="text-[var(--text-secondary)] hover:text-[var(--primary-color)] transition-colors"
                href="https://www.facebook.com/devkhadijamtasiu"
                aria-label="Facebook"
                target="_blank"
                rel="noopener noreferrer"
            >
